...
public interface ClientService {
    ...
    public void makeCall(Long clientId, Calendar date, Integer duration, ModelConstants.enumType type, String destPhone) throws InstanceNotFoundException, InputValidationException;
